...
N_placement_car = 20; % # of placement we create with every selected car/group of cars
...
translate_lim = [-6000, 6000; 3000, 12000]; % limits of the translation along the x and y axis
